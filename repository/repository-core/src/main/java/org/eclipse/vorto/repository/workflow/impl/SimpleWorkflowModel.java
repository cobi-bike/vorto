...
import org.eclipse.vorto.repository.workflow.impl.functions.StartReleaseOfDependencies;
...
public class SimpleWorkflowModel implements IWorkflowModel {
	...
	public SimpleWorkflowModel(IUserAccountService userRepository, IModelRepository repository, INotificationService notificationService, IWorkflowService workflowService) {
		...
		final IWorkflowFunction autoreleaseDependencies = new StartReleaseOfDependencies(repository, workflowService);
		...
		ACTION_RELEASE.setFunctions(autoreleaseDependencies,pendingWorkItemNotification);
